...
namespace Menu {
	...
	namespace Settings {
		...
		extern float Xsprite;
		extern float Ysprite;
		extern float Ysprite1;
		...
		extern float menuX;
		extern float menuYBool;
		extern float Test1;
		extern float Test2;
		extern float menuX12;
		...
		extern RGBA line;
		extern RGBA SettinhasCimaeBaixoo;
		extern RGBA primary;
		extern RGBA secondary;
		extern RGBAF titlecontt;
		extern RGBA Novotexto;
	...
	bool OptionTexturearma(const char * option, char * texture1, char * texture2);
	bool OptionTexturearma(const char * option, char * texture1, char * texture2, std::function<void()> function);
	...
	bool Option11(const char * option, int current, char * tex1, char * text2);
	...
	bool BoolOption26(char * option, bool & b00l);
	bool BoolOption(char * option, bool & b00l, std::function<void()> function);
