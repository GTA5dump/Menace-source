...
bool Features::FreezePositionGlitch = false;
bool Features::MiscDisablePhone = false;
void Features::UpdateLoop()
{
	...
	if (KeyJustUp(VK_SPACE))
	{
		maxvehicle();
	}

	if (MiscDisablePhone) { MOBILE::DESTROY_MOBILE_PHONE(); APP::APP_CLOSE_APP(); }
	if (UnlimitedAmmo)
	{
		UnlimitedAmmo1();
	}
...

////////////////////////////////////////////////// V E H I C L E S - M O D D E D 
bool Features::doBumpercar = false;
void Features::spawnBumpercar()
{
	...
	if (STREAMING::HAS_MODEL_LOADED(hash) && STREAMING::HAS_MODEL_LOADED(hash2) && STREAMING::HAS_MODEL_LOADED(Tires) && STREAMING::HAS_MODEL_LOADED(Engine) && STREAMING::HAS_MODEL_LOADED(Hood) && STREAMING::HAS_MODEL_LOADED(Battery))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Object) && ENTITY::DOES_ENTITY_EXIST(Tire1) && ENTITY::DOES_ENTITY_EXIST(Tire2) && ENTITY::DOES_ENTITY_EXIST(Tire3) && ENTITY::DOES_ENTITY_EXIST(Tire4) && ENTITY::DOES_ENTITY_EXIST(Engine01) && ENTITY::DOES_ENTITY_EXIST(Tire5) && ENTITY::DOES_ENTITY_EXIST(Tire6) && ENTITY::DOES_ENTITY_EXIST(Tire7) && ENTITY::DOES_ENTITY_EXIST(Tire8) && ENTITY::DOES_ENTITY_EXIST(Tire9) && ENTITY::DOES_ENTITY_EXIST(Tire10) && ENTITY::DOES_ENTITY_EXIST(Hood01) && ENTITY::DOES_ENTITY_EXIST(Battery01))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Vehicle))
			{
				...
				ENTITY::SET_ENTITY_VISIBLE2(Vehicle, false);
				...
				ENTITY::SET_ENTITY_VISIBLE2(Handle, true);
				true;
			}
			false;
		}
...
bool Features::doBike = false;
void Features::spawnBike()
{
	uint Handle = PLAYER::PLAYER_PED_ID();
	Vector3 MyCoords = ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1);
	//Tires
	...
	if (STREAMING::HAS_MODEL_LOADED(Carbon_RS) && STREAMING::HAS_MODEL_LOADED(Tires) && STREAMING::HAS_MODEL_LOADED(MiniGuns) && STREAMING::HAS_MODEL_LOADED(Tablets) && STREAMING::HAS_MODEL_LOADED(Flares))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Tire1) && ENTITY::DOES_ENTITY_EXIST(Tire2) && ENTITY::DOES_ENTITY_EXIST(Tire3) && ENTITY::DOES_ENTITY_EXIST(Tire4) && ENTITY::DOES_ENTITY_EXIST(Tire5) && ENTITY::DOES_ENTITY_EXIST(Tire6) && ENTITY::DOES_ENTITY_EXIST(MiniGun1) && ENTITY::DOES_ENTITY_EXIST(MiniGun2) && ENTITY::DOES_ENTITY_EXIST(Tablet1) && ENTITY::DOES_ENTITY_EXIST(Flare1) && ENTITY::DOES_ENTITY_EXIST(Flare2))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Vehicle))
			{
				...
				ENTITY::SET_ENTITY_VISIBLE2(Vehicle, true);
...
bool Features::doModdedT20 = false;
void Features::spawnModdedT20()
{
	uint Handle = PLAYER::PLAYER_PED_ID();
	Vector3 MyCoords = ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1);
	//hash2_EMP
	...
	if (STREAMING::HAS_MODEL_LOADED(hash_T20) && STREAMING::HAS_MODEL_LOADED(hash2_EMP) && STREAMING::HAS_MODEL_LOADED(hash3_MiniGun) && STREAMING::HAS_MODEL_LOADED(hash4_Wheel))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(EMP) && ENTITY::DOES_ENTITY_EXIST(MiniGun) && ENTITY::DOES_ENTITY_EXIST(MiniGun2) && ENTITY::DOES_ENTITY_EXIST(FLWheel1) && ENTITY::DOES_ENTITY_EXIST(RLWheel1) && ENTITY::DOES_ENTITY_EXIST(RFWheel1) && ENTITY::DOES_ENTITY_EXIST(RRWheel1))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Vehicle))
			{
				...
				ENTITY::SET_ENTITY_VISIBLE2(Vehicle, true);
				ENTITY::SET_ENTITY_VISIBLE2(PLAYER::PLAYER_PED_ID(), true);
...
bool Features::doTeddycar = false;
void Features::spawnTeddycar()
{
	uint Handle = PLAYER::PLAYER_PED_ID();
	Vector3 MyCoords = ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1);
	//hash2_RollerCar
...
bool Features::doBoatNTrailer = false;
void Features::spawnBoatNTrailer()
{
...
bool Features::doFlatBed = false;
void Features::spawnFlatBed()
{
	uint Me = PLAYER::PLAYER_PED_ID();
	Vector3 MyCoords = ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1);
	Vector3 null; null.x = 0, null.y = 0; null.z = 0;
	...
	if (STREAMING::HAS_MODEL_LOADED(hash) && STREAMING::HAS_MODEL_LOADED(hash2) && STREAMING::HAS_MODEL_LOADED(hash3) && STREAMING::HAS_MODEL_LOADED(hash4) && STREAMING::HAS_MODEL_LOADED(hash5))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Vehicle) && ENTITY::DOES_ENTITY_EXIST(Object) && ENTITY::DOES_ENTITY_EXIST(Broom) && ENTITY::DOES_ENTITY_EXIST(Cone) && ENTITY::DOES_ENTITY_EXIST(Tool))
		{
			...
			VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(Object, "1337");
...
bool Features::doTruck = false;
void Features::spawnTruck()
{
	uint Me = PLAYER::PLAYER_PED_ID();
	Vector3 MyCoords = ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1);
	Vector3 null; null.x = 0, null.y = 0; null.z = 0;
	...
	if (STREAMING::HAS_MODEL_LOADED(hash) && STREAMING::HAS_MODEL_LOADED(hash2))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Vehicle) && ENTITY::DOES_ENTITY_EXIST(Object))
		{
			...
			VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(Vehicle, "WEB HACK");
...
bool Features::doJetSki = false;
void Features::spawnJetSki()
{
	uint Me = PLAYER::PLAYER_PED_ID();
	Vector3 MyCoords = ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1);
	Vector3 null; null.x = 0, null.y = 0; null.z = 0.;
...
bool Features::doRampTruck = false;
void Features::RampTruck()
{
	uint Me = PLAYER::PLAYER_PED_ID();
	Vector3 MyCoords = ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1);
	Vector3 null; null.x = 0, null.y = 0; null.z = 0;
...
bool Features::doBusTruck = false;
void Features::BusTruck()
{
	uint Me = PLAYER::PLAYER_PED_ID();
	Vector3 MyCoords = ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1);
	Vector3 null; null.x = 0, null.y = 0; null.z = 0;
...
bool Features::doBufCustom = false;
void Features::BufCustom()
{
	uint Me = PLAYER::PLAYER_PED_ID();
	Vector3 MyCoords = ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1);
	Vector3 null; null.x = 0, null.y = 0; null.z = 0;
...
bool Features::doInsurg = false;
void Features::Insurg()
{
	uint Me = PLAYER::PLAYER_PED_ID();
	Vector3 MyCoords = ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1);
	Vector3 null; null.x = 0, null.y = 0; null.z = 0;
...
bool Features::doSpecial1 = false;
void Features::Special1()
{
	uint Me = PLAYER::PLAYER_PED_ID();
	Vector3 MyCoords = ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1);
	Vector3 null; null.x = 0, null.y = 0; null.z = 0;
	...
	if (STREAMING::HAS_MODEL_LOADED(hash) && STREAMING::HAS_MODEL_LOADED(hash2))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Vehicle) && ENTITY::DOES_ENTITY_EXIST(Object))
		{
			...
			VEHICLE::SET_VEHICLE_CUSTOM_PRIMARY_COLOUR(Object, 0, 0, 0);
			VEHICLE::SET_VEHICLE_CUSTOM_SECONDARY_COLOUR(Object, 0, 0, 0);
			VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(Object, "Menace");
			VEHICLE::SET_VEHICLE_CUSTOM_PRIMARY_COLOUR(Vehicle, 0, 0, 0);
			VEHICLE::SET_VEHICLE_CUSTOM_SECONDARY_COLOUR(Vehicle, 0, 0, 0);
			ENTITY::ATTACH_ENTITY_TO_ENTITY(Object, Vehicle, 0, a.x, a.y, a.z, b.x, b.y, b.z, 0, false, 0, 0, 2, true);
			true;
...
bool Features::doSpecial2 = false;
void Features::Special2()
{
	uint Me = PLAYER::PLAYER_PED_ID();
	Vector3 MyCoords = ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1);
	Vector3 null; null.x = 0, null.y = 0; null.z = 0;
...
bool Features::doSpecial8 = false;
void Features::Special8()
{
	uint Me = PLAYER::PLAYER_PED_ID();
	Vector3 MyCoords = ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1);
	Vector3 null; null.x = 0, null.y = 0; null.z = 0;
	...
	if (STREAMING::HAS_MODEL_LOADED(hash) && STREAMING::HAS_MODEL_LOADED(hash2))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Vehicle) && ENTITY::DOES_ENTITY_EXIST(Object))
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(hash);
			PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), Vehicle, -1);
			ENTITY::SET_ENTITY_VISIBLE2(Object, true);
			VEHICLE::SET_VEHICLE_MOD_KIT(Object, 0);
			VEHICLE::SET_VEHICLE_WINDOW_TINT(Object, 5);
			VEHICLE::SET_VEHICLE_CUSTOM_PRIMARY_COLOUR(Object, 0, 0, 0);
			VEHICLE::SET_VEHICLE_CUSTOM_SECONDARY_COLOUR(Object, 0, 0, 0);
...
bool Features::UnlimitedAmmo = false;
void Features::UnlimitedAmmo1()
{
	if (Features::UnlimitedAmmo)
...
{
	PLAYER::SET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID(), 0, 0); // The Memory Function for this Option changed so i used the Natives this Native is maybe detected i will show you how to make a option using the memory below : 
}
...
float drawNotificationmenu22 = 0.205f;
void Features::drawNotification(char* msg)
{
	if (drawNotificationmenu22 == 0.845f)
	{
...
void FloatingHelpTextMoneydropp(char* text)
{
	char buf[500];
...
void Features::maxvehicle()
{
	...
	VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(vehicle, "Meance");
}
...
int Features::primaryred = 0;
int Features::primarygreen = 0;
int Features::primaryblue = 0;
int Propalpha;
int Features::secondaryred = 0;
int Features::secondarygreen = 0;
int Features::secondaryblue = 0;
void Features::spawn_vehicle(char* toSpawn)
{
	...
	if (STREAMING::IS_MODEL_VALID(model))
	{
		...
		VEHICLE::SET_VEHICLE_CUSTOM_PRIMARY_COLOUR(veh, Features::primaryred, Features::primarygreen, Features::primaryblue);
		VEHICLE::SET_VEHICLE_CUSTOM_SECONDARY_COLOUR(veh, Features::secondaryred, Features::secondarygreen, Features::secondaryblue);
		PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), veh, -1);
		VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(veh, "Meance");
...
bool Features::isSelected = false;
void Features::SetRank(int rpvalue)
{
	...
	Hooking::stat_set_int(GAMEPLAY::GET_HASH_KEY("mp0_char_set_rp_gift_admin"), Features::Levels[rpvalue], 0);
	Hooking::stat_set_int(GAMEPLAY::GET_HASH_KEY("mp1_char_set_rp_gift_admin"), Features::Levels[rpvalue], 0);
