...
float Menu::Settings::menuX = 0.85f;// menu´posição
...
int Menu::Settings::currentOption = 16;
int Menu::Settings::optionCount = 16;
...
RGBAF Menu::Settings::titleText{ 255, 255, 255, 255, 7 };//cor de letras titulo
RGBA Menu::Settings::titleRect{ 0, 0, 255, 150 };// cor titulo
RGBAF Menu::Settings::optionText{ 255, 255, 255, 255, 6 };//texto cor
RGBAF Menu::Settings::breakText{ 255, 255, 255, 255, 1 };// break
RGBAF Menu::Settings::arrow{ 255, 255, 255, 255, 3 };                          // Mod Menu Colors 
RGBA Menu::Settings::optionRect{ 0, 0, 0, 110 };
RGBA Menu::Settings::scroller{ 255, 255, 255, 96 };//scroiler
RGBAF Menu::Settings::integre{ 255, 0, 255, 255, 2 };//int float
RGBA Menu::Settings::line{ 0, 0, 255, 255 };
RGBA Menu::Settings::SettinhasCimaeBaixoo{ 255, 255, 255, 255 };
RGBA Menu::Settings::primary{ 255, 255, 0 };
RGBA Menu::Settings::secondary{ 0, 255, 255 };
rgba boolLIgado = { 0, 255, 0, 255 };
rgba BoolDesligado = { 255, 0, 0, 255 };

rgba TESTT1 = { 0, 0, 255, 255 };
RGBAF Menu::Settings::titlecontt{ 255, 255, 255, 255, 6 };
float Menu::Settings::menuX12 = 0.77f;



float Menu::Settings::Xsprite = 0.250f;
float Menu::Settings::Ysprite = 0.165f;
float Menu::Settings::Ysprite1 = 0.265f;
...
void DrawSprite555(char * Streamedtexture, char * textureName, float x, float y, float width, float height, float rotation, int r, int g, int b, int a)
{
...
void Menu::Title(const char * title)
{
	...
	Drawing::Rect(Settings::titleRect, { Settings::menuX, 0.1175f }, { 0.21f, 0.090f });
	//drawSprite("mpclubpreset6", "mpclubpreset6", Settings::menuX + /*ESQUERDA E DIREITA >>>*/0.000f/*<<<ESQUERDA E DIREITA*/, (Settings::optionCount * 0.035f +/*>>CIMA E BAIXO>>*/ 0.120f), 0.12f, 0.12f, 0, TESTT1);//on //boneco de rock
	drawSprite("mpclubemblem", "mpclubemblem2", Settings::menuX + /*ESQUERDA E DIREITA >>>*/ 0.070f/*<<<ESQUERDA E DIREITA*/, (Settings::optionCount * 0.035f +/*>>CIMA E BAIXO>>*/ 0.120f), 0.12f, 0.12f, 0, TESTT1);//on //caveira
	drawSprite("mpclubemblem", "mpclubemblem3", Settings::menuX + /*ESQUERDA E DIREITA >>>*/ -0.070f/*<<<ESQUERDA E DIREITA*/, (Settings::optionCount * 0.035f +/*>>CIMA E BAIXO>>*/ 0.120f), 0.12f, 0.12f, 0, TESTT1);//on //caveira
...
bool Menu::OptionTexturearma(const char * option, char* texture1, char* texture2)
{
	...
	if (Settings::currentOption <= 16 && Settings::optionCount <= 16)
	{
		...
		drawSprite(texture1, texture2, Settings::menuX + /*ESQUERDA E DIREITA >>>*/0.075f/*<<<ESQUERDA E DIREITA*/, (Settings::optionCount * 0.035f +/*>>CIMA E BAIXO>>*/ 0.142f), 0.04f, 0.04f, 0, TESTT1);//on
	}
...
bool Menu::OptionTexturearma(const char * option, char* texture1, char* texture2, std::function<void()> function)
{
	OptionTexturearma(option, texture1, texture2);
...
bool Menu::Option11(const char * option, int current, char *tex1, char *text2)
{
	Settings::optionCount++;
	bool onThis = Settings::currentOption == Settings::optionCount ? true : false;
	if (Settings::currentOption <= 16 && Settings::optionCount <= 16)
...
bool Menu::BoolOption26(char* option, bool & b00l)
{
	Option(option);
	if (b00l)
	{
		if(Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
			drawSprite("mpleaderboard", b00l ? "leaderboard_globe_icon" : "leaderboard_globe_icon", Settings::menuX + /*ESQUERDA E DIREITA >>>*/0.092f/*<<<ESQUERDA E DIREITA*/, (Settings::optionCount * 0.035f +/*>>CIMA E BAIXO>>*/ 0.142f), 0.04f, 0.04f, 0, boolLIgado);//on
	else if (Settings::optionCount > Settings::currentOption - Settings::maxVisOptions && Settings::optionCount <= Settings::currentOption)//on
		drawSprite("mpleaderboard", b00l ? "leaderboard_globe_icon" : "leaderboard_globe_icon", Settings::menuX + /*ESQUERDA E DIREITA >>>*/0.092f, (Settings::optionCount * 0.035f +/*>>CIMA E BAIXO>>*/ 0.142f), 0.04f, 0.04f, 0, boolLIgado);//on
	}
	else
	{
		if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
			drawSprite("mpleaderboard", b00l ? "leaderboard_globe_icon" : "leaderboard_globe_icon", Settings::menuX + /*ESQUERDA E DIREITA >>>*/0.092f/*<<<ESQUERDA E DIREITA*/, (Settings::optionCount * 0.035f +/*>>CIMA E BAIXO>>*/ 0.142f), 0.04f, 0.04f, 0, BoolDesligado);//OFF
		else if (Settings::optionCount > Settings::currentOption - Settings::maxVisOptions && Settings::optionCount <= Settings::currentOption)//OFF
			drawSprite("mpleaderboard", b00l ? "leaderboard_globe_icon" : "leaderboard_globe_icon", Settings::menuX +/*ESQUERDA E DIREITA >>>*/ 0.092f/*<<<ESQUERDA E DIREITA*/, (Settings::optionCount * 0.035f + /*>>CIMA E BAIXO>>*/0.142f), 0.04f, 0.04f, 0, BoolDesligado);//OFF
...
bool Menu::BoolOption(char * option, bool & b00l, std::function<void()> function)
{
	BoolOption26(option, b00l);
	if (Settings::optionCount == Settings::currentOption && Settings::selectPressed) 
	{
		function();
		return true;
...
void Menu::End()
{
	...
	if (opcount >= 16) 
	{
		...
		Drawing::Text("V 1.48", Settings::titlecontt, { Settings::menuX12, 17 * 0.035f + 0.125f }, { 0.5f, 0.5f }, true);
		Drawing::Spriter("commonmenu", "shop_arrows_upanddown", Settings::menuX, ((16 + 1) * 0.035f + 0.140f), 0.020f, 0.035f, 180, Settings::SettinhasCimaeBaixoo.r, Settings::SettinhasCimaeBaixoo.g, Settings::SettinhasCimaeBaixoo.b, Settings::SettinhasCimaeBaixoo.a);
	}
	else if (opcount > 0) 
	{
		...
		Drawing::Text("V 1.48", Settings::titlecontt, { Settings::menuX12, (Settings::optionCount + 1) * 0.035f + 0.125f }, { 0.5f, 0.5f }, true);
		Drawing::Spriter("commonmenu", "shop_arrows_upanddown", Settings::menuX, ((Settings::optionCount + 1) * 0.035f + 0.140f), 0.020f, 0.035f, 180, Settings::SettinhasCimaeBaixoo.r, Settings::SettinhasCimaeBaixoo.g, Settings::SettinhasCimaeBaixoo.b, Settings::SettinhasCimaeBaixoo.a);
	}
}
...
int Menu::Settings::keyPressDelay3 = 50;
