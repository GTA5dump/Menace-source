...
namespace PLAYER
{
	...
	static void SET_PLAYER_WANTED_CENTRE_POSITION11(Player player, float x, float y, float z) { invoke<Void>(0x520E541A97A13354, player, x, y, z); } // 0x520E541A97A13354 0xF261633A
	...
	static int GET_PLAYER_MAX_ARMOUR22(Player player, BOOL p1) { return invoke<int>(0x92659B4CE1863CB3, player, p1); } // 0x92659B4CE1863CB3 0x02A50657
	...
	static BOOL GET_PLAYER_INVINCIBLEGodmode(Player player, BOOL toggle) { return invoke<BOOL>(0xB721981B2B939E07, player, toggle); } // 0xB721981B2B939E07 0x680C90EE
...
namespace ENTITY
{
	static void SET_ENTITY_VISIBLE2(Entity entity, BOOL toggle) { invoke<Void>(0xEA1C610A04DB6BBB, entity, toggle); } // 0xEA1C610A04DB6BBB 0xD043E8E1
	...
	static Vector3 GET_ENTITY_COORDS22(Entity entity, BOOL alive) { return invoke<Vector3>(0x3FEF770D40960D5A, entity, alive); } // 0x3FEF770D40960D5A 0x1647F1CB
...
namespace OBJECT
{
	...
	static Object GET_CLOSEST_OBJECT_OF_TYPE1(float x, float y, float z, float radius, Hash modelHash, BOOL isMission) { return invoke<Object>(0xE143FA2249364369, x, y, z, radius, modelHash, isMission); } // 0xE143FA2249364369 0x45619B33
...
namespace WEAPON
{
	...
	static Object CREATE_WEAPON_OBJECT1(Hash weaponHash, int ammoCount, float x, float y, float z, BOOL showWorldModel, float heading) { return invoke<Object>(0x9541D3CF0D398F36, weaponHash, ammoCount, x, y, z, showWorldModel, heading); } // 0x9541D3CF0D398F36 0x62F5987F
...
namespace GRAPHICS
{
	...
	static void DRAW_RECT2(float* xyz1, float* xyz2, int r, int g, int b, int a) { invoke<Void>(0x3A618A217E5154F0, xyz1, xyz2, r, g, b, a); } // 0x3A618A217E5154F0 0xDD2BFC77
...
namespace STATS
{
	...
	{
		static tSTAT_SET_INT oSTAT_SET_INT = (tSTAT_SET_INT)(Memory::pattern("48 89 5C 24 ? 48 89 74 24 ? 89 54 24 10 55 57 41 57").count(1).get(0).get<void>(0));
		return oSTAT_SET_INT(statName, value, save);
	}
...
namespace FIRE
{
	...
	static void REMOVE_SCRIPT_FIRE22(float X, float Y, float Z, int fireHandle) { invoke<Void>(0x7FF548385680673F, fireHandle); } // 0x7FF548385680673F 0x6B21FE26
	...
	static void ADD_EXPLOSION22(float x, float y, float z, int explosionType, float damageScale, BOOL isAudible, BOOL isInvisible, float cameraShake, BOOL doesDamage) { invoke<Void>(0xE3AD2BDBAEE269AC, x, y, z, explosionType, damageScale, isAudible, isInvisible, cameraShake); } // 0xE3AD2BDBAEE269AC 0x10AF5258
